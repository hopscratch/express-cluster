...
(function() {
  ...
  master = function(config) {
    ...
    for (i = _i = 0, _ref1 = workerCount - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
      ...
      // If we have a custom online listener, listen for it
      if (typeof config.onlineListener === "function" && config.onlineEvent !== "online") {
        worker.on(config.onlineEvent, onlineHandler);
      }
